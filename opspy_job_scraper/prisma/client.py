...
class Prisma(AsyncBasePrisma):
    ...
    jobapplication: 'actions.JobApplicationActions[models.JobApplication]'
    jobpost: 'actions.JobPostActions[models.JobPost]'
    jobtracker: 'actions.JobTrackerActions[models.JobTracker]'
    tag: 'actions.TagActions[models.Tag]'
    uploadedcv: 'actions.UploadedCvActions[models.UploadedCv]'
    user: 'actions.UserActions[models.User]'
    workexperience: 'actions.WorkExperienceActions[models.WorkExperience]'
    ...
    def __init__(
        ...
        *,
        ...
        self.jobapplication = actions.JobApplicationActions[models.JobApplication](self, models.JobApplication)
        self.jobpost = actions.JobPostActions[models.JobPost](self, models.JobPost)
        self.jobtracker = actions.JobTrackerActions[models.JobTracker](self, models.JobTracker)
        self.tag = actions.TagActions[models.Tag](self, models.Tag)
        self.uploadedcv = actions.UploadedCvActions[models.UploadedCv](self, models.UploadedCv)
        self.user = actions.UserActions[models.User](self, models.User)
        self.workexperience = actions.WorkExperienceActions[models.WorkExperience](self, models.WorkExperience)
...
class Batch:
    ...
    jobapplication: 'JobApplicationBatchActions'
    jobpost: 'JobPostBatchActions'
    jobtracker: 'JobTrackerBatchActions'
    tag: 'TagBatchActions'
    uploadedcv: 'UploadedCvBatchActions'
    user: 'UserBatchActions'
    workexperience: 'WorkExperienceBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.jobapplication = JobApplicationBatchActions(self)
        self.jobpost = JobPostBatchActions(self)
        self.jobtracker = JobTrackerBatchActions(self)
        self.tag = TagBatchActions(self)
        self.uploadedcv = UploadedCvBatchActions(self)
        self.user = UserBatchActions(self)
        self.workexperience = WorkExperienceBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class JobApplicationBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class WorkExperienceBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
